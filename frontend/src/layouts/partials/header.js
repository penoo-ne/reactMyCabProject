...
const Header = () => {
  ...
  <a href="#" className="dropdown-toggle" data-toggle="dropdown">
    <img src="theme/dist/img/user2-160x160.jpg" className="user-image" alt="User Image" />
    <span className="hidden-xs">Alexander Pierce</span>
  </a>
  <ul className="dropdown-menu">
    {/* User image */}
    <li className="user-header">
      <img src="theme/dist/img/user2-160x160.jpg" className="img-circle" alt="User Image" />
      <p>
