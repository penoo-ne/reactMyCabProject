          ...
          <div className="col-xs-8">
            <div className="box">
              <div className="box-header">
                <h3 className="box-title pull-left"><b>Customer Admins</b></h3>
              </div>
                  ...
                  <div className="box-body">
                    ...
                    <div className="direct-chat-messages">
                      ...
                      <div className="direct-chat-msg">
                        ...
                        <img className="direct-chat-img" src="theme/dist/img/user1-128x128.jpg" alt="Message User Image" />
                      ...
                      <div className="direct-chat-msg right">
                        ...
                        <img className="direct-chat-img" src="theme/dist/img/user3-128x128.jpg" alt="Message User Image" />
                        <div className="direct-chat-text">
                    ...
                    <div className="direct-chat-contacts">
                      <ul className="contacts-list">
                        <li>
                          <a href="#">
                            <img className="contacts-list-img" src="theme/dist/img/user1-128x128.jpg" alt="User Image" />
